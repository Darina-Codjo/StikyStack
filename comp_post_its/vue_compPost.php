...
<body>
<header>
    <h1>Welcome, <?php echo htmlspecialchars($fnameUser); ?>!</h1>
    <nav>
...
<main>
    <div class="post-it-section">
        <h2>My Post-its</h2>
        <button class="add-button" onclick="openForm()">Add Post-its</button>
        <div class="post-it-display" id="mesPostIts"></div>
    </div>
    <div class="post-it-section" style="background-color: #ffcab0;">
        <h2>Post-its Shared</h2>
        <div class="post-it-display" id="postItsShared"></div>
    </div>
</main>
...
<div class="form-popup" id="myForm">
    <form class="form-container" action="submit_postit.php" method="post">
        ...
        <input type="text" id="title" name="title" placeholder="Enter title" required maxlength="150">
        <label for="content"><b>content</b></label>
        <textarea placeholder="Écrivez le content" name="content" required></textarea>
...
<div class="form-popup" id="editForm">
    <form class="form-container" onsubmit="modifierPostIt(event)">
        ...
        <input type="text" id="edit-title" name="edit-title" required maxlength="50">

        <label for="edit-content"><b>content</b></label>
        <textarea id="edit-content" name="edit-content" required
